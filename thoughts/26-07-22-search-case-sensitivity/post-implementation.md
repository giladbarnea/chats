...
As of 2026-08-09, only exact uppercase `AND`, `OR`, and `NOT` tokens are operators. The mode still controls term matching only, including positive and negated terms in `NotQuery`.
