...
[*\[CICD\]*](https://github.com/sharkdp/fd/actions/workflows/CICD.yml)
[*\[Version info\]*](https://crates.io/crates/fd-find)
...
![Demo](screencast.svg)
> Animated SVG screencast demonstrating fd command-line usage.
> Animated SVG screencast demonstrating fd command-line usage.
...
[*\[Packaging status\]*](https://repology.org/project/fd-find/versions)
