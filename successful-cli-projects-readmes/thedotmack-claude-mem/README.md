<h1 align="center">
  ...
  <a href="https://github.com/thedotmack/claude-mem">
    <picture>
      ...
      <img src="claude-mem-logo-for-light-mode.webp" alt="Claude-Mem" width="400">
      > Claude-Mem logo for light mode with an orange sun icon.
      > Claude-Mem logo for light mode with an orange sun icon.
    </picture>
  </a>
  <br>
      ...
      <a href="https://github.com/thedotmack/claude-mem">
        <picture>
          <img
            ...
            width="500"
          >
          > Preview demonstration of the Claude-Mem compression system in action.
          > Preview demonstration of the Claude-Mem compression system in action.
        </picture>
      </a>
    </td>
      ...
      <a href="https://www.star-history.com/#thedotmack/claude-mem&Date">
        <picture>
          ...
          <img
            ...
            width="500"
          />
          > GitHub star history chart showing the growth of stars over time.
          > GitHub star history chart showing the growth of stars over time.
        </picture>
      </a>
    </td>
